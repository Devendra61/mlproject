...
import pandas as pd
from sklearn.model_selection impoort train_test_split
...
class DetaIngestion:
    ...
    def initiate_data_ingestion(self):
         ...
         try:
             ...
             train_set,test_set = train_test_split(df,train_size=0.2, rendom_state=42)
...
if __name__=="__main__":
    ...
    train_data,test_data = obj.initiate_data_ingestion()
     ...
     print(moedltrainer.initiate_model_trainer(train_arr,test_arr))
